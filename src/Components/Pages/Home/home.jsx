...
// Images
import Face from "../../Assets/images/faces/face13.jpg";
const Home = () => {
                            ...
                            <div className="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                              <div className="card bg-success">
                                <div className="card-body px-3 py-4">
                                  <div className="d-flex justify-content-between align-items-start">
                                    <div className="color-card">
                                      <p className="mb-0 color-card-head">
                                        Affiliate
                                      </p>
                        ...
                        <div className="col-xl-4 col-sm-6 grid-margin stretch-card">
                          <div className="card">
                            <div className="card-body">
                              ...
                              <p className="text-muted">
                                Lorem ipsum dolor sitadipiscing elit, sed amet do
                                eiusmod tempor we find a new solution{" "}
                              </p>
                                  ...
                                  <p className="text-muted">
                                    ...
                                    <span className=" d-inline-block">
                                      <span className="d-flex d-inline-block">
                                        ...
                                        <img
                                          className="ml-1"
                                          src="/demo/breeze/react/template/demo_1/preview/static/media/face14.5fb72289.jpg"
                                          alt=""
                                        />
                                      </span>
                                    </span>
